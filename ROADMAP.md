...
Sequenced into six sub-releases per [docs/superpowers/specs/2026-09-11-v1.1-scope-design.md](docs/superpowers/specs/2026-09-11-v1.1-scope-design.md): a (security-relevant policy gaps), b (correctness/coverage), c (reliability/packaging), d (test coverage), e (new capability, #22), f (dedicated documentation batch, last). **v1.1a shipped** via [#76](https://github.com/simonives/redwrench/pull/76) (2026-09-15): #71, #72, #46, #48, #52, #51, #54, #58, #59, #75, all closed. **v1.1b (correctness/coverage) is next**: #43, #45, #49, #50, #60.
